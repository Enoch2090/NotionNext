...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || 'faec7054ada545f1907d15cf75189e4a',
      ...
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Enoch2090', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://enoch2090.me', // 网站地址
      ...
      PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-one-light.min.css', // 代码块默认主题
      PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
      PRISM_THEME_LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-one-light.min.css', // 浅色模式主题
      PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-one-dark.min.css', // 深色模式主题
      ...
      TITLE: process.env.NEXT_PUBLIC_TITLE || 'Enoch2090', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
      HOME_BANNER_IMAGE:
            process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
      DESCRIPTION:
            process.env.NEXT_PUBLIC_DESCRIPTION || 'Welcome to Nowhere\'s land', // 站点描述，被notion中的页面描述覆盖
